...
<jsp:useBean id="mgr" class="beerking.RequestBoardMgr"/>
<%

String path = "C:/Jsp/beerking/beerking/WebContent/beerking/userimg/"; // 이미지가 저장될 주소
String filename = "";
...
<%
	...
	try {
		...
		if (!upfile.equals("")) {
			...
			mgr.uploadFile(filename, request.getContentLength());
